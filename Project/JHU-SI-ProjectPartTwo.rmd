...
A residual plot (residuals vs fitted values) and qq plot are shown in Appendix 4. The residual plot should shown no pattern, and looks fine, while the qq plot should be a straight line if the normality of distribution of differences criterion for the validity of the ANOVA analysis is to be satisfied. It isn't quite, perhaps a consequence of the small sample size.
